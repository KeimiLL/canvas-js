    ...
    <div class="properties">
        ...
        <div class="props">
            <div class="feature" id="div-slider">
                ...
                <p>Grubość: <span id="slider-value" style="color:rgb(15, 48, 9); font-weight: bold;">5</span></p>
            </div>

            <div class="feature" id="div-color">
                <input id="color" type="color" name="color" value="#000000" />
                <p>Kolor: <span id="color-value" style="color:rgb(15, 48, 9); font-weight: bold;">#000000</span></p>
            </div>
        </div>
